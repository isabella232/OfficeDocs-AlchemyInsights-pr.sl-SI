...
---
# <a name="update-dns-records-at-google-enom"></a>Posodabljanje zapisov DNS v Googlu (eNom)

Uporabite spodnje povezave za pomoč pri posodabljanju zapisov DNS.

- [Ustvarjanje zapisov DNS v Googlu (eNom](https://docs.microsoft.com/microsoft-365/admin/dns/create-dns-records-for-domain-managed-by-google-enom?view=o365-worldwide)
