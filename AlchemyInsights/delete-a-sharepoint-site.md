...
ms.locfileid: "36513699"
---
# <a name="delete-a-site-from-the-new-sharepoint-admin-center"></a>Izbriši stran od centra nove SharePoint admin
...
- Za trajno odstraniti spletno mesto, si oglejte [mesta trajno izbrisati](https://docs.microsoft.com/sharepoint/delete-site-collection#permanently-delete-a-site). Ta korak bo potrebna, če nameravate ponovno uporabo URL. 
- Umakniti podmesto, glej [mesta izbrisati ali podmesta quicksteps](https://support.office.com/article/Delete-a-SharePoint-site-or-subsite-bc37b743-0cef-475e-9a8c-8fc4d40179fb#__bkmkshortcut)
