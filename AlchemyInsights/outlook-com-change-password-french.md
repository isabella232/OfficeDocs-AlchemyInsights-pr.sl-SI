...
3. Entrez votre MOT de Passe aktuel, votre Nouveau MOT de Passe, puis sélectionnez **enregistrer**.

Si vous avez oublié votre MOT de Passe, accédez à la [Page de réinicializacija de MOT de Passe de Compte Microsoft](https://go.microsoft.com/fwlink/p/?linkid=841909), puis suivez Les vabi.
