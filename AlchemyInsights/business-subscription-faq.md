...
ms.locfileid: "50469066"
---
# <a name="business-subscription-faq"></a>Pogosta vprašanja o naročnini za podjetja

- Če si želite ogledati možnosti za Microsoft 365 za podjetja, si oglejte [Primerjajte poslovne pakete](https://www.microsoft.com/microsoft-365/compare-all-microsoft-365-products?&activetab=tab:primaryr2). Če želite več informacij, se obrnite na prodajo na številko 1-855-270-0615.
- Če želite **kupiti** paket, izberite razdelek **Obračunavanje > [Nakup storitev](https://go.microsoft.com/fwlink/p/?linkid=868433)**. Izberite načrt in število uporabnikov. Če želite več informacij, si oglejte [Kupite drugo naročnino](https://docs.microsoft.com/microsoft-365/commerce/try-or-buy-microsoft-365#buy-a-different-subscription).
...
- Če želite **znova aktivirati** naročnino, si oglejte [Znova aktivirajte naročnino](https://docs.microsoft.com/alchemyinsights/reactivate-your-subscription).
- Če želite **podaljšati** preskusno različico, si oglejte [Podaljšajte preskusno različico](https://docs.microsoft.com/microsoft-365/commerce/extend-your-trial).
