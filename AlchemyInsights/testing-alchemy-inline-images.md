...
---
# <a name="access-the-domains-page"></a><span data-ttu-id="8bd13-102">Dostop do strani domen</span><span class="sxs-lookup"><span data-stu-id="8bd13-102">Access the Domains Page</span></span>

<span data-ttu-id="8bd13-103">Če želite dostopati do strani domen, preprosto kliknite to ikono spodaj:</span><span class="sxs-lookup"><span data-stu-id="8bd13-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="8bd13-104">Nato lahko dodate, spreminjate ali odstranite domeno.</span><span class="sxs-lookup"><span data-stu-id="8bd13-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="8bd13-105">Če želite več informacij, glejte [pogosta vprašanja o domenah.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="8bd13-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span></span>
