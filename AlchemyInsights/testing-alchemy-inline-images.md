---
title: Preskušanje alkimije inline slike
ms.author: pebaum
author: pebaum
ms.date: 04/21/2020
ms.audience: ITPro
...
ms.locfileid: "44505071"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="2e345-102">Dostop do strani domen</span><span class="sxs-lookup"><span data-stu-id="2e345-102">Access the Domains Page</span></span>

<span data-ttu-id="2e345-103">Če želite dostopati do strani domen, preprosto kliknite to ikono spodaj:</span><span class="sxs-lookup"><span data-stu-id="2e345-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="2e345-104">Nato lahko dodate, spreminjate ali odstranite domeno.</span><span class="sxs-lookup"><span data-stu-id="2e345-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="2e345-105">Če želite več informacij, glejte [pogosta vprašanja o domenah.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="2e345-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span></span>
