---
title: Preskušanje slik v vrstici» Alchemy «
ms.author: pebaum
author: pebaum
ms.date: 04/21/2020
ms.audience: ITPro
...
ms.locfileid: "47669408"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="033ba-102">Dostop do strani» domene «</span><span class="sxs-lookup"><span data-stu-id="033ba-102">Access the Domains Page</span></span>

<span data-ttu-id="033ba-103">Če želite dostopati do strani Domains (domene), kliknite to ikono spodaj:</span><span class="sxs-lookup"><span data-stu-id="033ba-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="033ba-104">Nato lahko dodate, spremenite ali odstranite domeno.</span><span class="sxs-lookup"><span data-stu-id="033ba-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="033ba-105">Če želite več informacij, glejte [pogosta vprašanja o domenah.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="033ba-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span></span>
