...
ms.locfileid: "28312586"
---
# <a name="search-experience-updated"></a><span data-ttu-id="94603-102">Preiskava doživetje posodobljen</span><span class="sxs-lookup"><span data-stu-id="94603-102">Search experience updated</span></span>

<span data-ttu-id="94603-p101">Iskanje je zdaj nahaja na dnu app. prisluškovanje na to vam omogoča neposreden dostop do top stikov, prihajajoči potovalnih načrtov, paket dobave, in nedavni Priloge. Iskanje e-poštnih sporočil, datotek in stike v kateri koli od vaših računov iz enega enotnega iskalno polje ali pa uporabite naše nove filtre iskanje.</span><span class="sxs-lookup"><span data-stu-id="94603-p101">Search is now located at the bottom of the app. Tapping on it gives you direct access to your top contacts, upcoming travel itineraries, package deliveries, and recent attachments. You can search for email messages, files, and contacts in any of your accounts from one single search box or use our new filters to narrow your search.</span></span>
