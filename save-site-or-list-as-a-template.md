...
---
# <a name="save-site-or-list-as-a-template"></a>Shraniti stran ali seznam kot predlogo
...
**Shrani seznam mest/svetišče popek je ni na voljo ali pa manjka**. 

- Skrbniki morali dovoliti skript po meri omogočiti funkcije predlog. Podrobni koraki, primeri in vidiki glejte [Dovoli ali prepreči skript po meri](https://docs.microsoft.com/en-us/sharepoint/allow-or-prevent-custom-script).
...
- Preverite, če vse sezname ali knjižnice presega [Omejitev prag pogleda seznama](https://support.office.com/en-us/article/Manage-large-lists-and-libraries-in-SharePoint-B8588DAE-9387-48C2-9248-C24122F07C59) 5000 artiklov, kot to lahko preprečijo nastanek predlogo mesta.


- Stran morda uporabljate preveč sredstev in zato predlogo mesta presega omejitev 50 megabajtov (MB).
...
Za podrobnejše informacije o skupnih problemov in rešitve vas prosimo, reference, [Ustvarjanje in uporabo predloge mest](https://support.office.com/en-us/article/Create-and-use-site-templates-60371B0F-00E0-4C49-A844-34759EBDD989).
